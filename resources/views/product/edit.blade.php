...
<div class="container">
    <div class="row">
        <div class="card">
            <div class="card-header">{{ __('Редактирование Товара') }}</div>

            <div class="card-body">
                <form enctype="multipart/form-data" method="POST" action="/product/{{$product->id}}/update">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{$product->title}}" class="form-control" name="title"  required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{$product->price}}" class="col-md-4 col-form-label text-md-end" name="price"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="{{$product->size}}" name="size" required autofocus>
                        </div>
                    </div>
